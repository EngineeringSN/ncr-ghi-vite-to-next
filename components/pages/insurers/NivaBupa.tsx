        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3">
              <h1 className="text-4xl font-bold mb-4">Niva Bupa Health Insurance</h1>
              <p className="text-xl mb-6">
                Dedicated health insurance provider with comprehensive coverage options and wellness programs.
              </p>
            </div>
            <div className="md:w-1/3 flex justify-center">
              <img src="/public/lovable-uploads/Niva-Bupa-Logo.png" alt="Niva Bupa Logo" className="h-24 w-auto bg-white p-4 rounded-lg" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <a href="/public/lovable-uploads/insurerPdfs/niva_bupa_wordings.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">1800-103-6061 (Toll Free)</span>
                </div>
                <div className="flex items-center">
