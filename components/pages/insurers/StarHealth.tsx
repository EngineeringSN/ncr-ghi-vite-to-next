  ...
  const branches = [
    {
      ...
      address:
        "Ground Floor, Plot No. 142, Sector 44, Gurugram, Haryana - 122003",
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3">
              ...
              <p className="text-xl mb-6">
                India's leading standalone health insurance company with
                comprehensive coverage and excellent claim settlement.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Star Health and Allied Insurance Company Limited is India's
                first standalone health insurance company. Established in 2006,
                Star Health has been providing comprehensive health insurance
                solutions to individuals, families, and corporates across India.
              </p>
              <p className="text-gray-600 mb-6">
                With over 15 years of experience in the health insurance sector,
                Star Health has built a reputation for innovative products,
                excellent customer service, and quick claim settlements.
              </p>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <a
                  href="/lovable-uploads/insurerPdfs/Star-Group-Health-Insurance.pdf"
                  target="_blank"
                ...
                <div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-700 mb-2">
                      <strong>Name:</strong> Mr. S. Prakash
                      <br />
                      <strong>Email:</strong> grievance@starhealth.in
                      <br />
      ...
      <section className="bg-securenow-orange text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Secure your health with India's leading standalone health insurance
            provider. Get a customized quote today.
          </p>
          <a
