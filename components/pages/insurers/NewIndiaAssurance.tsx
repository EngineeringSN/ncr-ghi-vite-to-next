...
const NewIndiaAssurance = () => {
  const breadcrumbItems = [{ label: "insurers" },{ label: "new-india-assurance" }];
  return (
    <>
    <BreadcrumbSchema/>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3">
              ...
              <p className="text-xl mb-6">
                India's premier public sector insurance company with widespread
                presence and reliable service.
              </p>
            </div>
            <div className="md:w-1/3 flex justify-center">
              <Image
                src="/lovable-uploads/niaBlue2.png"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <a
                  href="/lovable-uploads/insurerPdfs/New India Mediclaim Policy.pdf"
                  target="_blank"
