...
const BajajAllianz = () => {
  ...
  const branches = [{
    ...
    address: "Plot No. 2, Sector 126, Expressway, Noida, Uttar Pradesh - 201303",
    phone: "1800-209-5858",
    type: "Regional Office"
  }, {
    name: "Bajaj Allianz - Gurugram Branch",
    address: "3rd Floor, Building No. 5, DLF Cyber City, Phase III, Gurugram, Haryana - 122002",
    phone: "1800-209-5858",
    type: "Branch Office"
  }];
  const keyFeatures = ["98.1% Claim Settlement Ratio", "6,500+ Network Hospitals", "Health Returns Program", "No-Claim Bonus", "24/7 Claim Support", "Digital Health Card"];
    ...
    <MainLayout>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3">
              <h1 className="text-4xl font-bold mb-4">Bajaj Allianz General Insurance</h1>
              <p className="text-xl mb-6">
                Comprehensive health coverage with quick claim settlement and extensive hospital network across India.
              </p>
            </div>
            <div className="md:w-1/3 flex justify-center">
              <img src="/public/lovable-uploads/bajajlogo.png" alt="Bajaj Allianz Logo" className="h-24 w-auto bg-white p-4 rounded-lg" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-securenow-blue mb-6">About Bajaj Allianz</h2>
              <p className="text-gray-600 mb-4">
                Bajaj Allianz General Insurance is a joint venture between Bajaj Finserv Limited and Allianz SE. 
                Since 2001, the company has been providing comprehensive insurance solutions with a strong focus 
                on customer satisfaction and innovative products.
              </p>
              <p className="text-gray-600 mb-6">
                With a robust network and strong financial backing, Bajaj Allianz offers reliable health insurance 
                solutions that provide peace of mind and comprehensive coverage for individuals and corporates.
              </p>
            </div>
            <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-bold text-securenow-blue mb-2">1,600+ Network Hospitals</h3>
              <p className="text-gray-600">in Delhi NCR Region</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                <h4 className="text-lg font-bold text-securenow-blue mb-2">Leading Hospitals</h4>
              ...
              <div>
                <h4 className="text-lg font-bold text-securenow-blue mb-2">Specialty Care</h4>
                <ul className="text-gray-600 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <a 
                  href="/public/lovable-uploads/insurerPdfs/bajaj_policy_wording.pdf" 
                  target="_blank" 
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">1800-209-5858 (Toll Free)</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">bagiccare@bajajallianz.co.in</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-700 mb-2">
                      <strong>Name:</strong> Mr. Suresh Agarwal<br />
                      <strong>Email:</strong> complaints.cmr@bajajallianz.co.in<br />
      ...
      <section className="bg-securenow-orange text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Get Bajaj Allianz Insurance</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Secure comprehensive health coverage with trusted insurance solutions from Bajaj Allianz.
          </p>
