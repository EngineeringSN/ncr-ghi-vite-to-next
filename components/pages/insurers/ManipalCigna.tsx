  ...
  return <MainLayout>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3">
              <h1 className="text-4xl font-bold mb-4">Manipal Cigna Health Insurance</h1>
              <p className="text-xl mb-6">
                Global expertise with local understanding, offering comprehensive health insurance solutions.
              </p>
            </div>
            <div className="md:w-1/3 flex justify-center">
              <img src="/public/lovable-uploads/cigna.png" alt="Manipal Cigna Logo" className="h-24 w-auto bg-white p-4 rounded-lg" />
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 border border-gray-200 rounded-lg bg-gray-50">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-600">Group Health Insurance Policy</h4>
                    <p className="text-gray-500 text-sm">Contact customer service for policy documents</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">1800-123-2442 (Toll Free)</span>
                </div>
                <div className="flex items-center">
                  <Mail className="h-5 w-5 text-securenow-blue mr-3" />
                  <span className="text-gray-700">customercare@manipalcigna.com</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-securenow-orange text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Get Manipal Cigna Insurance</h2>
