...
const RelianceGeneral = () => {
  const keyFeatures = ["96.5% Claim Settlement Ratio", "5,000+ Network Hospitals", "Instant E-Card", "Mobile Claim Processing", "Health Checkup Benefits", "24x7 Customer Support"];
  return <MainLayout>
      {/* Header Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3">
              <h1 className="text-4xl font-bold mb-4">Reliance General Insurance</h1>
              <p className="text-xl mb-6">
                Strong network coverage with innovative health insurance solutions for corporate clients.
              </p>
            </div>
            <div className="md:w-1/3 flex justify-center">
              <img src="/public/lovable-uploads/reliance_GI.png" alt="Reliance General Insurance Logo" className="h-24 w-auto bg-white p-4 rounded-lg" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <a href="/public/lovable-uploads/insurerPdfs/reliance_Policy_Wording.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">1800-3009-3009 (Toll Free)</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">rgicare@relianceada.com</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="bg-securenow-orange text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Get Reliance General Insurance</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Experience innovative health insurance solutions with comprehensive coverage.
          </p>
