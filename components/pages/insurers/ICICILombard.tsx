  ...
  const branches = [
    {
      ...
      address:
        "ICICI Lombard House, 414, Veer Savarkar Block, Shakarpur, Delhi - 110092",
      phone: "1800-2666",
    ...
    },
    {
      ...
      address:
        "Tower A, 9th Floor, DLF IT Park, Sector 25A, Gurugram, Haryana - 122002",
      phone: "1800-2666",
      type: "Branch Office",
    },
  ];
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3">
              ...
              <p className="text-xl mb-6">
                Leading private sector general insurance company providing
                comprehensive health coverage with superior customer service.
              </p>
            </div>
            <div className="md:w-1/3 flex justify-center">
              <Image
                width={316}
                height={89}
                src="/lovable-uploads/icicilogo.png"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                ICICI Lombard General Insurance Company is one of the premier
                non-life insurance companies in India. A joint venture between
                ICICI Bank and Fairfax Financial Holdings, the company has been
                serving customers since 2001 with innovative insurance
                solutions.
              </p>
              <p className="text-gray-600 mb-6">
                Known for its customer-centric approach and technological
                innovations, ICICI Lombard offers comprehensive health insurance
                products designed to meet the evolving healthcare needs of
                modern India.
              </p>
            </div>
            <div>
                ...
                <div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-700 mb-2">
                      <strong>Name:</strong> Ms. Priya Sharma
                      <br />
                      <strong>Email:</strong> grievance@icicilombard.com
                      <br />
      ...
      <section className="bg-securenow-orange text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Get ICICI Lombard Insurance
          </h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Choose India's leading private sector insurance company for
