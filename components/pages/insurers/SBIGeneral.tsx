  ...
  return <MainLayout>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3">
              <h1 className="text-4xl font-bold mb-4">SBI General Insurance</h1>
              <p className="text-xl mb-6">
                Reliable health insurance provider with simple and hassle-free claim settlement process.
              </p>
            </div>
            <div className="md:w-1/3 flex justify-center">
              <img src="/public/lovable-uploads/sbig-logo.png" alt="SBI General Insurance Logo" className="h-24 w-auto bg-white p-4 rounded-lg" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <a href="/public/lovable-uploads/insurerPdfs/sbi_wordings.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">1800-123-1588 (Toll Free)</span>
                </div>
                <div className="flex items-center">
                  <Mail className="h-5 w-5 text-securenow-blue mr-3" />
                  <span className="text-gray-700">care@sbigeneral.in</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-securenow-orange text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Get SBI General Insurance</h2>
