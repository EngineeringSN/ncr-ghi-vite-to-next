...
const TataAIG = () => {
  const branches = [
    {
      ...
      address:
        "Peninsula Corporate Park, A-401, 4th Floor, Lower Parel, Mumbai - 400013",
      phone: "1800-266-7780",
  ...
  const keyFeatures = [
    ...
    "4,000+ Network Hospitals",
    "Global Coverage",
    "Critical Illness Cover",
    "Maternity Benefits",
    "Pre-Policy Health Check-up",
  ];
  const breadcrumbItems = [{ label: "insurers" },{ label: "tata-aig" }];
  return (
    <>
      {/* Header Section */}
      <BreadcrumbSchema/>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3">
              ...
              <p className="text-xl mb-6">
                Trusted insurance provider with customizable health plans and
            ...
            <div className="md:w-1/3 flex justify-center">
              <Image
                width={150}
                height={100}
                src="/lovable-uploads/TataAIG.png"
                alt="Tata AIG Logo"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                ...
                Tata Group and American International Group. The company
                combines Tata's trusted brand legacy with AIG's global insurance
                expertise.
              </p>
              <p className="text-gray-600 mb-6">
                Known for providing customizable insurance solutions, Tata AIG
                offers comprehensive health coverage that adapts to changing
                healthcare needs and lifestyle requirements.
              </p>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <a
                  href="/lovable-uploads/insurerPdfs/Tata_AIG_Medi_Care_82932b277a.pdf"
                  target="_blank"
                ...
                <div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-700 mb-2">
                      <strong>Name:</strong> Mr. Amit Singh
                      <br />
                      <strong>Email:</strong> grievance.officer@tataaig.com
                      <br />
      ...
      <section className="bg-securenow-orange text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Choose trusted insurance solutions with global expertise and local
            understanding.
          </p>
          <a
