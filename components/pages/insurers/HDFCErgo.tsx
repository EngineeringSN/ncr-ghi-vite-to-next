...
import hdfergoLogo from "@/public/lovable-uploads/hdfergo.png";
const HDFCErgo = () => {
  ...
  const branches = [
    {
      ...
      address:
        "4th Floor, Building No. 9, DLF Cyber City, Phase II, Gurugram, Haryana - 122002",
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3">
              ...
              <p className="text-xl mb-6">
                Digital-first health insurance solutions with innovative
                technology and comprehensive coverage for modern healthcare
                needs.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                HDFC ERGO General Insurance Company is a joint venture between
                HDFC Ltd and ERGO International AG. Since its inception in 2002,
                HDFC ERGO has been at the forefront of providing innovative
                insurance solutions with a strong focus on technology and
                customer experience.
              </p>
              <p className="text-gray-600 mb-6">
                Known for its digital-first approach, HDFC ERGO offers seamless
                health insurance solutions that combine traditional insurance
                expertise with cutting-edge technology to provide superior
                customer service.
              </p>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <a
                  href="/lovable-uploads/insurerPdfs/HDFC-Group-Health-Insurance_Policy Wording.pdf"
                  target="_blank"
                ...
                <div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-700 mb-2">
                      <strong>Name:</strong> Mr. Rajesh Kumar
                      <br />
                      <strong>Email:</strong> grievance@hdfcergo.com
                      <br />
      ...
      <section className="bg-securenow-orange text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Experience digital-first health insurance with comprehensive
