...
const InsurerComparison: React.FC<InsurerComparisonProps> = ({
  currentInsurer,
}) => {
  const allInsurers: Insurer[] = [
    {
      ...
      logo: "/lovable-uploads/starlogo.png",
      claimRatio: "98.5%",
    ...
    },
    {
      ...
      logo: "/lovable-uploads/hdfergo.png",
      claimRatio: "99.8%",
      networkHospitals: "12,000+",
    ...
    },
    {
      ...
      logo: "/lovable-uploads/icicilogo.png",
      claimRatio: "97.8%",
    ...
    },
    {
      ...
      logo: "/lovable-uploads/bajajlogo.png",
      claimRatio: "98.1%",
    ...
    },
    {
      ...
      logo: "/lovable-uploads/TataAIG.png",
      claimRatio: "97.5%",
    ...
    },
    {
      ...
      logo: "/lovable-uploads/Niva-Bupa-Logo.png",
      claimRatio: "98.3%",
    ...
    <section className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-securenow-blue mb-4">
            Compare with Other Insurers
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore other leading insurance providers to find the best fit for
            your needs.
          </p>
        </div>
            ...
            >
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-securenow-blue">
