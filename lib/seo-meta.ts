...
export const seoMeta: Record<string, Metadata> = {
  home: {
    ...
    openGraph: {
      ...
      description:
        "Get the best group health insurance for your business in Delhi NCR. Comprehensive employee coverage with 30+ insurance partners, 24/7 support, and trusted by 3000+ companies. Request free quote today.",
      url: "https://grouphealthinsurance.co",
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/",
        "hi-IN": "https://grouphealthinsurance.co"+"/hi",
      },
    },
  },
  productfeature: {
    ...
    openGraph: {
      ...
      description:
        "Explore advanced group health insurance features: cashless hospitalization, OPD coverage, wellness programs, family inclusion, maternity benefits, and more. Compare plans now.",
      url: "https://grouphealthinsurance.co"+"/product-features/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/product-features/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/product-features/",
        "hi-IN": "https://grouphealthinsurance.co"+"/product-features/hi",
      },
    },
  },
  roomrentcapping: {
    ...
    openGraph: {
      ...
      description:
        "Understand room rent capping in group health insurance. Learn how room rent limits affect your claims and discover policies with no capping for maximum coverage.",
      url: "https://grouphealthinsurance.co"+"/product-features/room-rent-capping/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/product-features/room-rent-capping/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/product-features/room-rent-capping/",
        "hi-IN": "https://grouphealthinsurance.co"+"/product-features/room-rent-capping/hi",
      },
    },
  },
  copay: {
    ...
    openGraph: {
      ...
      description:
        "Understand room rent capping in group health insurance. Learn how room rent limits affect your claims and discover policies with no capping for maximum coverage.",
      url: "https://grouphealthinsurance.co"+"/product-features/copay/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/product-features/copay/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/product-features/copay/",
        "hi-IN": "https://grouphealthinsurance.co"+"/product-features/copay/hi",
      },
    },
  },
  cashlessopd: {
    ...
    openGraph: {
      ...
      description:
        "Enhance employee benefits with cashless OPD coverage. No advance payments for doctor consultations, diagnostics, medicines, and preventive healthcare. Check OPD plans.",
      url: "https://grouphealthinsurance.co"+"/product-features/cashless-opd/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/product-features/cashless-opd/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/product-features/cashless-opd/",
        "hi-IN": "https://grouphealthinsurance.co"+"/product-features/cashless-opd/hi",
      },
    },
  },
  insurance: {
    ...
    openGraph: {
      ...
      description:
        "Compare India's leading health insurance companies for group coverage. Check claim settlement ratios, network hospitals, and premium rates from 30+ trusted insurers.",
      url: "https://grouphealthinsurance.co"+"/insurers/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/insurers/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/insurers/",
        "hi-IN": "https://grouphealthinsurance.co"+"/insurers/hi",
      },
    },
  },
  policywordings: {
    ...
    openGraph: {
      ...
      description:
        "Download detailed health insurance policy wordings from top insurers. Read terms, conditions, exclusions, and coverage details before choosing your group health plan.",
      url: "https://grouphealthinsurance.co"+"/insurers/policy-wordings/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/insurers/policy-wordings/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/insurers/policy-wordings/",
        "hi-IN": "https://grouphealthinsurance.co"+"/insurers/policy-wordings/hi",
      },
    },
  },
  claimsettlementrate: {
    ...
    openGraph: {
      ...
      description:
        "Compare claim settlement ratios of top health insurance companies in India. Choose insurers with highest claim approval rates for hassle-free settlements.",
      url: "https://grouphealthinsurance.co"+"/insurers/claim-settlement-rate/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/insurers/claim-settlement-rate/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/insurers/claim-settlement-rate/",
        "hi-IN": "https://grouphealthinsurance.co"+"/insurers/claim-settlement-rate/hi",
      },
    },
  },
  tpa: {
    ...
    openGraph: {
      ...
      description:
        "Compare leading TPA providers for seamless health insurance services. Access 15,000+ network hospitals, fast claim processing, and cashless treatment across India. Choose the best TPA for your needs.",
      url: "https://grouphealthinsurance.co"+"/tpa/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/tpa/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/tpa/",
        "hi-IN": "https://grouphealthinsurance.co"+"/tpa/hi",
      },
    },
  },
  claimprocess: {
    ...
    openGraph: {
      ...
      description:
        "Step-by-step guide to health insurance claims. Learn cashless hospitalization process, reimbursement procedures, required documents, and get 24/7 claim support.",
      url: "https://grouphealthinsurance.co"+"/claim-process/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/claim-process/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/claim-process/",
        "hi-IN": "https://grouphealthinsurance.co"+"/claim-process/hi",
      },
    },
  },
  cashless: {
    ...
    openGraph: {
      ...
      description:
        "Complete guide to cashless health insurance. Learn how cashless hospitalization works, pre-authorization process, and access 15,000+ network hospitals nationwide.",
      url: "https://grouphealthinsurance.co"+"/claim-process/cashless/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/claim-process/cashless/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/claim-process/cashless/",
        "hi-IN": "https://grouphealthinsurance.co"+"/claim-process/cashless/hi",
      },
    },
  },
  reimbursement: {
    ...
    openGraph: {
      ...
      description:
        "Learn health insurance reimbursement process. Required documents, claim forms, submission timeline, and tips for faster reimbursement settlements.",
      url: "https://grouphealthinsurance.co"+"/claim-process/reimbursement/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/claim-process/reimbursement/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/claim-process/reimbursement/",
        "hi-IN": "https://grouphealthinsurance.co"+"/claim-process/reimbursement/hi",
      },
    },
  },
  prepostclaim: {
    ...
    openGraph: {
      ...
      description:
        "Understand pre and post hospitalization coverage in health insurance. Learn about covered expenses, time limits, and how to claim pre/post hospitalization benefits.",
      url: "https://grouphealthinsurance.co"+"/claim-process/pre-post-claim/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/claim-process/pre-post-claim/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/claim-process/pre-post-claim/",
        "hi-IN": "https://grouphealthinsurance.co"+"/claim-process/pre-post-claim/hi",
      },
    },
  },
  gipsa: {
    ...
    openGraph: {
      ...
      description:
        "Access GIPSA's extensive network of 15,000+ hospitals for cashless treatment. Find network hospitals near you and enjoy seamless healthcare services.",
      url: "https://grouphealthinsurance.co"+"/claim-process/gipsa/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/claim-process/gipsa/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/claim-process/gipsa/",
        "hi-IN": "https://grouphealthinsurance.co"+"/claim-process/gipsa/hi",
      },
    },
  },
  claimstatus: {
    ...
    openGraph: {
      ...
      description:
        "Track your health insurance claim status in real-time. Get instant updates via online portal, SMS, email, or WhatsApp. Check claim progress 24/7.",
      url: "https://grouphealthinsurance.co"+"/claim-process/claim-status/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/claim-process/claim-status/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/claim-process/claim-status/",
        "hi-IN": "https://grouphealthinsurance.co"+"/claim-process/claim-status/hi",
      },
    },
  },
  quotation: {
    ...
    openGraph: {
      ...
      description:
        "Get free, customized group health insurance quotes from 30+ top insurers. Compare plans, premiums, and benefits within 24 hours. No obligation quotes.",
      url: "https://grouphealthinsurance.co"+"/quotation/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/quotation/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/quotation/",
        "hi-IN": "https://grouphealthinsurance.co"+"/quotation/hi",
      },
    },
  },
  process: {
    ...
    openGraph: {
      ...
      description:
        "Learn our transparent quotation process for group health insurance. Get customized quotes from multiple insurers, compare benefits, and choose the best plan.",
      url: "https://grouphealthinsurance.co"+"/quotation/process/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/quotation/process/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/quotation/process/",
        "hi-IN": "https://grouphealthinsurance.co"+"/quotation/process/hi",
      },
    },
  },
  raters: {
    ...
    openGraph: {
      ...
      description:
        "Understand factors affecting group health insurance premiums: employee age, coverage amount, claim history, location, and more. Get accurate premium estimates.",
      url: "https://grouphealthinsurance.co"+"/quotation/raters/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/quotation/raters/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/quotation/raters/",
        "hi-IN": "https://grouphealthinsurance.co"+"/quotation/raters/hi",
      },
    },
  },
  claimratio: {
    ...
    openGraph: {
      ...
      description:
        "Learn how claim ratios affect your group health insurance premiums and renewals. Understand incurred claim ratio and its impact on future costs.",
      url: "https://grouphealthinsurance.co"+"/quotation/claim-ratio/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/quotation/claim-ratio/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/quotation/claim-ratio/",
        "hi-IN": "https://grouphealthinsurance.co"+"/quotation/claim-ratio/hi",
      },
    },
  },
  installments: {
    ...
    openGraph: {
      ...
      description:
        "Pay group health insurance premiums in flexible installments. Choose monthly, quarterly, or half-yearly payment options to manage cash flow better.",
      url: "https://grouphealthinsurance.co"+"/quotation/installments/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/quotation/installments/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/quotation/installments/",
        "hi-IN": "https://grouphealthinsurance.co"+"/quotation/installments/hi",
      },
    },
  },
  voluntaryperks: {
    ...
    openGraph: {
      ...
      description:
        "Enhance employee benefits with voluntary perks. Offer optional health coverage, dental, vision, and wellness programs that employees can choose and pay for.",
      url: "https://grouphealthinsurance.co"+"/quotation/voluntary-perks/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/quotation/voluntary-perks/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/quotation/voluntary-perks/",
        "hi-IN": "https://grouphealthinsurance.co"+"/quotation/voluntary-perks/hi",
      },
    },
  },
  opd: {
    ...
    openGraph: {
      ...
      description:
        "Add comprehensive OPD coverage to your group health plan. Cover doctor consultations, diagnostics, medicines, and day-care treatments for employees.",
      url: "https://grouphealthinsurance.co"+"/quotation/opd/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/quotation/opd/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/quotation/opd/",
        "hi-IN": "https://grouphealthinsurance.co"+"/quotation/opd/hi",
      },
    },
  },
  topup: {
    ...
    openGraph: {
      ...
      description:
        "Boost your health coverage with affordable top-up plans. Get higher sum insured for critical illnesses and major medical expenses at lower premiums.",
      url: "https://grouphealthinsurance.co"+"/quotation/top-up/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/quotation/top-up/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/quotation/top-up/",
        "hi-IN": "https://grouphealthinsurance.co"+"/quotation/top-up/hi",
      },
    },
  },
  industry: {
    ...
    openGraph: {
      ...
      description:
        "Discover health insurance solutions tailored for your industry. Specialized coverage for tech, construction, consulting, e-commerce, and more business sectors.",
      url: "https://grouphealthinsurance.co"+"/industry/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/industry/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/industry/",
        "hi-IN": "https://grouphealthinsurance.co"+"/industry/hi",
      },
    },
  },
  tech: {
    ...
    openGraph: {
      ...
      description:
        "Comprehensive health insurance for tech companies and startups. Mental health coverage, wellness programs, and benefits that attract top IT talent.",
      url: "https://grouphealthinsurance.co"+"/industry/tech/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/industry/tech/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/industry/tech/",
        "hi-IN": "https://grouphealthinsurance.co"+"/industry/tech/hi",
      },
    },
  },
  consulting: {
    ...
    openGraph: {
      ...
      description:
        "Specialized health insurance for consulting firms with frequent travelers. International coverage, flexible benefits, and comprehensive healthcare solutions.",
      url: "https://grouphealthinsurance.co"+"/industry/consulting/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/industry/consulting/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/industry/consulting/",
        "hi-IN": "https://grouphealthinsurance.co"+"/industry/consulting/hi",
      },
    },
  },
  eCommerce: {
    ...
    openGraph: {
      ...
      description:
        "Tailored health insurance for e-commerce businesses covering diverse workforce from warehouse staff to tech teams with 24/7 support and flexible benefits.",
      url: "https://grouphealthinsurance.co"+"/industry/e-commerce/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/industry/e-commerce/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/industry/e-commerce/",
        "hi-IN": "https://grouphealthinsurance.co"+"/industry/e-commerce/hi",
      },
    },
  },
  food: {
    ...
    openGraph: {
      ...
      description:
        "Specialized health coverage for food service, restaurants, and hospitality businesses. Address industry-specific health risks with customized insurance solutions.",
      url: "https://grouphealthinsurance.co"+"/industry/food/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/industry/food/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/industry/food/",
        "hi-IN": "https://grouphealthinsurance.co"+"/industry/food/hi",
      },
    },
  },
  construction: {
    ...
    openGraph: {
      ...
      description:
        "Comprehensive health insurance for construction companies covering site workers, engineers, and office staff. Occupational health coverage and accident protection.",
      url: "https://grouphealthinsurance.co"+"/industry/construction/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/industry/construction/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/industry/construction/",
        "hi-IN": "https://grouphealthinsurance.co"+"/industry/construction/hi",
      },
    },
  },
  smallBusiness: {
    ...
    openGraph: {
      ...
      description:
        "Cost-effective group health insurance for small businesses with 5+ employees. Compete with larger companies by offering quality health benefits to your team.",
      url: "https://grouphealthinsurance.co"+"/industry/small-business/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/industry/small-business/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/industry/small-business/",
        "hi-IN": "https://grouphealthinsurance.co"+"/industry/small-business/hi",
      },
    },
  },
  gigWorkers: {
    ...
    openGraph: {
      ...
      description:
        "Health insurance solutions for gig workers, freelancers, and contract employees. Flexible coverage options for the modern workforce.",
      url: "https://grouphealthinsurance.co"+"/industry/gig-workers/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/industry/gig-workers/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/industry/gig-workers/",
        "hi-IN": "https://grouphealthinsurance.co"+"/industry/gig-workers/hi",
      },
    },
  },
  technology: {
    ...
    openGraph: {
      ...
      description:
        "Experience cutting-edge insurance technology for seamless group health plan management. Digital claims, real-time analytics, and automated policy administration.",
      url: "https://grouphealthinsurance.co"+"/technology/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/technology/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/technology/",
        "hi-IN": "https://grouphealthinsurance.co"+"/technology/hi",
      },
    },
  },
  dashboard: {
    ...
    openGraph: {
      ...
      description:
        "Access comprehensive insurance dashboard for real-time policy monitoring, employee enrollment tracking, claim analytics, and detailed reporting.",
      url: "https://grouphealthinsurance.co"+"/technology/dashboard/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/technology/dashboard/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/technology/dashboard/",
        "hi-IN": "https://grouphealthinsurance.co"+"/technology/dashboard/hi",
      },
    },
  },
  eClaims: {
    ...
    openGraph: {
      ...
      description:
        "Streamline health insurance claims with digital processing. Faster settlements, paperless submissions, real-time tracking, and automated claim workflows.",
      url: "https://grouphealthinsurance.co"+"/technology/e-claims/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/technology/e-claims/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/technology/e-claims/",
        "hi-IN": "https://grouphealthinsurance.co"+"/technology/e-claims/hi",
      },
    },
  },
  flexiPlans: {
    ...
    openGraph: {
      ...
      description:
        "Design flexible health insurance plans tailored to your workforce. Allow employees to customize coverage options based on individual and family needs.",
      url: "https://grouphealthinsurance.co"+"/technology/flexi-plans/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/technology/flexi-plans/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/technology/flexi-plans/",
        "hi-IN": "https://grouphealthinsurance.co"+"/technology/flexi-plans/hi",
      },
    },
  },
  service: {
    ...
    openGraph: {
      ...
      description:
        "Experience exceptional health insurance services with dedicated account managers, 24/7 support, policy administration, and personalized assistance for your business.",
      url: "https://grouphealthinsurance.co"+"/service/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/service/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/service/",
        "hi-IN": "https://grouphealthinsurance.co"+"/service/hi",
      },
    },
  },
  endorsement: {
    ...
    openGraph: {
      ...
      description:
        "Make seamless changes to your group health insurance policy. Add/remove employees, update coverage, and process endorsements within 24 hours.",
      url: "https://grouphealthinsurance.co"+"/service/endorsement/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/service/endorsement/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/service/endorsement/",
        "hi-IN": "https://grouphealthinsurance.co"+"/service/endorsement/hi",
      },
    },
  },
  sla: {
    ...
    openGraph: {
      ...
      description:
        "Our commitment to excellence with defined SLAs for claims processing, endorsements, query resolution, and customer service. Guaranteed response times.",
      url: "https://grouphealthinsurance.co"+"/service/sla/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/service/sla/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/service/sla/",
        "hi-IN": "https://grouphealthinsurance.co"+"/service/sla/hi",
      },
    },
  },
  serviceCalls: {
    ...
    openGraph: {
      ...
      description:
        "Get instant help with our 24/7 insurance support helpline. Expert assistance for claims, policy queries, hospital network, and emergency support.",
      url: "https://grouphealthinsurance.co"+"/service/service-calls/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/service/service-calls/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/service/service-calls/",
        "hi-IN": "https://grouphealthinsurance.co"+"/service/service-calls/hi",
      },
    },
  },
  mediAssist: {
    ...
    openGraph: {
      ...
      description:
        "Medi Assist TPA offers India's largest network of 15,000+ hospitals with instant cashless treatment, 24x7 pre-authorization, and fastest claim settlement. Check hospital network now.",
      url: "https://grouphealthinsurance.co"+"/tpa/medi-assist/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/tpa/medi-assist/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/tpa/medi-assist/",
        "hi-IN": "https://grouphealthinsurance.co"+"/tpa/medi-assist/hi",
      },
    },
  },
  fhpl: {
    ...
    openGraph: {
      ...
      description:
        "FHPL TPA provides premium healthcare services with 10,000+ network hospitals, efficient claim processing, and superior customer service. Access quality healthcare nationwide.",
      url: "https://grouphealthinsurance.co"+"/tpa/fhpl/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/tpa/fhpl/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/tpa/fhpl/",
        "hi-IN": "https://grouphealthinsurance.co"+"/tpa/fhpl/hi",
      },
    },
  },
  Vidal: {
    ...
    openGraph: {
      ...
      description:
        "Vidal Health TPA specializes in corporate health insurance with 8,000+ network hospitals, quick pre-authorization, and comprehensive healthcare administration services.",
      url: "https://grouphealthinsurance.co"+"/tpa/vidal/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/tpa/vidal/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/tpa/vidal/",
        "hi-IN": "https://grouphealthinsurance.co"+"/tpa/vidal/hi",
      },
    },
  },
  Ghico: {
    ...
    openGraph: {
      ...
      description:
        "Government Health Insurance Company (GHICO) TPA provides specialized services for CGHS beneficiaries and government employees with dedicated support and streamlined processes.",
      url: "https://grouphealthinsurance.co"+"/tpa/ghico/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/tpa/ghico/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/tpa/ghico/",
        "hi-IN": "https://grouphealthinsurance.co"+"/tpa/ghico/hi",
      },
    },
  },
  PrivacyPolicy: {
    ...
    openGraph: {
      ...
      description:
        "Check SecureNow privacy policy details and know purpose and scope of insurance company privacy policy. You can know what user personal information they we collect.",
      url: "https://grouphealthinsurance.co"+"/privacy-policy/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/privacy-policy/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/privacy-policy/",
        "hi-IN": "https://grouphealthinsurance.co"+"/privacy-policy/hi",
      },
    },
  },
  TermsConditions: {
    ...
    openGraph: {
      ...
      description:
        "Know About SecureNow Terms & Conditions, Disclaimer, Warranties, Limitation of Liability, Cancellation, Refund, Warning, Jurisdiction, Trademarks and Copyrights Details.",
      url: "https://grouphealthinsurance.co"+"/terms-and-conditions/",
      siteName: "Group Health Insurance",
      type: "website",
      images: [
        {
    ...
    alternates: {
      canonical: "https://grouphealthinsurance.co"+"/terms-and-conditions/",
      languages: {
        "en-IN": "https://grouphealthinsurance.co"+"/terms-and-conditions/",
        "hi-IN": "https://grouphealthinsurance.co"+"/terms-and-conditions/hi",
      },
    },
  },
};
